  ...
  return (
    <div className={`${poppins.className} relative min-h-screen`}>
      ...
      <main className="p-5 md:p-10 pt-20 md:pt-32 text-center">
        <h1 className="text-4xl md:text-6xl lg:text-8xl font-semibold mt-20 leading-snug max-w-full break-words">
          We are <br />
          <span className="text-[#5474a5] font-bold">Youth Venture</span>
        </h1>
        <p className="text-[#828282] font-medium text-xl md:text-2xl lg:text-3xl p-3">
